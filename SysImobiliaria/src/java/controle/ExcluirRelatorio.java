...
public class ExcluirRelatorio extends HttpServlet {
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ExcluirRelatório</title>");
            out.println("</head>");
            out.println("<body>");
            String idRelatorio = request.getParameter("idRelatorio");
            if (idRelatorio == null || idRelatorio.equals("")) {
                out.print("Um relatório deve ser selecionado!");
            } else {
                try {
